...
public interface UserDao {
    ...
    String SELECT_QUERY = "SELECT user_id, email, password, username, current_timestamp at time zone 'EETDST' - last_time_online <= '10 MINUTE' as is_online, is_activated, is_verified, last_time_online," +
